...
export const EventAttendance = () => {
    ...
    return(
        <Container fluid style={{maxWidth:'656px', maxHeight: '377px', outline: '1px black solid', borderRadius: '20px'}} className='px-5 py-5'>
            <Row className=''>
                <Col xs={6} >
                ...
                <Col>
                    ...
                    <Container fluid className='mt-5 px-1 py-2' >
                        ...
                        <Row className='mt-3' style={{alignItems:'center'}}>
                            ...
                            <p className='mb-0' style={{width:'max-content', fontSize:'16px', display:'inline-block'}}>Didn`t Attend <span style={{color:'lightgrey'}}>__________</span>{nonAttend}% </p>
